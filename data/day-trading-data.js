window.mindmapData = {
  nodes: [
    {
      text: "0. Day Trading Strategies",
      classic: "Momentum & Reversal Strategy",
      person: "Ross Cameron",
      description: "Day trading strategy used by well-known traders like Ross Cameron.",
      application: "Ideal for trading volatile stocks with high volume spikes.",
      videoUrl: "https://www.youtube.com/embed/5X_ZcifasBg?si=3nwGtxheCT1Ns0Rd"
    },
    {
      text: "1. Market Analysis",
      classic: "Top-Down Market Scanning",
      person: "Linda Raschke",
      description: "Analyze market trends and liquidity, such as using the S&P 500 index to forecast direction.",
      application: "Used to establish daily bias before market opens.",
      chart: "https://www.investopedia.com/thmb/Vf7bp91IpkqVp6EN3HuwMHRhZ3g=/1500x0/stock-chart-sample.png"
    },
    {
      text: "2. Trading Plan Development",
      classic: "Elder's Triple Screen",
      person: "Alexander Elder",
      description: "Define entry/exit rules and targets, like Dr. Alexander Elder's planning approach.",
      application: "Improves consistency and removes emotion from decisions.",
    },
    {
      text: "3. Risk Management",
      classic: "2% Risk Rule",
      person: "Van Tharp",
      description: "Control risk with stop-losses and position sizing, e.g., the 2% rule for individual trades.",
      application: "Prevents large losses from single trades.",
    ...
    },
    {
      ...
      application: "Primary decision tool for day traders.",
      videoUrl:"https://www.youtube.com/embed/0L6Rcgp6j7Y?si=ccg96rqIPDoV0p_f"
    ...
    },
    {
      ...
      application: "Used to filter which stocks or assets to watch.",
    ...
    },
    {
      ...
      application: "Signals potential extremes in market psychology.",
    ...
    },
    {
      ...
      application: "Identifies breakout or breakdown points on the chart.",
    ...
    },
    {
      ...
      description: "Apply RSI, moving averages, and other indicators to assess market momentum.",
      application: "Confirm price strength or divergence for signals.",
    ...
    },
    {
      ...
      application: "Short-term traders prefer 9/20/50 EMAs for responsive signals.",
    ...
    },
    {
      ...
      application: "Used to time reversals or confirm breakouts in day trading.",
      formula: "RSI = 100 - [100 / (1 + RS)]"
    },
    {
    ...
    },
    {
      ...
      application: "Enforces discipline and removes emotional decision-making during losses.",
    ...
    },
    {
      ...
      application: "Key to long-term survival in fast-moving markets.",
    ...
    },
    {
      ...
      application: "Encourages traders to exit with discipline instead of chasing more profits.",
    ...
    },
    {
      ...
      application: "Builds a safety net into the trading routine, especially during volatile or losing days."
    },
    ...
    },
    {
      ...
      application: "Select trades that match your risk tolerance and adjust stop-losses accordingly.",
    ...
    },
    {
      ...
      application: "Avoid going all-in—proper capital allocation allows compounding and risk control.",
    ...
    },
    {
      ...
      application: "Match instruments to your strategy—e.g., futures for macro plays, ETFs for sector bets."
    }
